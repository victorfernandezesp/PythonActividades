...
class Respuesta_No_Encontrada(TypeError):
    def __init__(self):
...
if __name__ == '__main__':
    ...
    pr2 = Question("Normal vs Normal",
                   ...
                   ([("Efectivo", -0.25), ("Normal", 1), ("Poco efectivo", -0.25), ("No afecta", -0.50)]), 1)
    ...
    pr3 = Question("Dragon vs Hada",
                   ...
                   ([("Efectivo", -0.75), ("Normal", -0.25), ("Poco efectivo", 1), ("No afecta", -0.25)]), 1)
    ...
    pr4 = Question("Normal vs Fantasma",
                   ...
                   ([("Efectivo", -0.75), ("Normal", -0.50), ("Poco efectivo", -0.25), ("No afecta", 1)]), 1)
    ...
    pr5 = Question("Dragon vs Dragon",
                   ...
                   ([("Efectivo", 1), ("Normal", -0.25), ("Poco efectivo", -0.75), ("No afecta", -0.50)]), 1)
