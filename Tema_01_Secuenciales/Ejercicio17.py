""" 17. Un ciclista parte de una ciudad A a las HH horas, MM minutos y SS segundos. El tiempo de viaje hasta llegar a
        otra ciudad B es de T segundos. Escribir un algoritmo que determine la hora de llegada a la ciudad B.

    Author: Victor Fernandez España
    Curso:  2022-2003
"""
print(f"Este programa calcula la hora a la que llegara el ciclista a la ciudad B ")
