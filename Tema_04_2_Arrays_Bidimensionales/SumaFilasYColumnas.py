"""
    Este ejercicio pide las dimensiones de una matriz, se introducen los valores de la matriz, muestra la matriz
    y luego suma los distintos valores comprendidos entre las filas y las columnas.
