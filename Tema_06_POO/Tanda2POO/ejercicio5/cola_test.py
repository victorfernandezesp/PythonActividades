...
print(f"La longitud de la cola es: {cola1.longitud}")
print(f"{cola1.esta_vacia()}")
cola1.encolar(1)
print(f"La cola encolada: {cola1}")
print(f"El elemento que se ha descolado: {cola1.desencolar()}.  ")
...
print(f"La longitud de la cola es: {cola2.longitud}")
print(f"{cola2.esta_vacia()}")
cola2.encolar(1)
cola2.encolar(2)
cola2.encolar(3)
print(f"La cola encolada: {cola2}")
print(f"El elemento que se ha descolado: {cola2.desencolar()}.  ")
...
print(f"La longitud de la cola es: {cola3.longitud}")
print(f"{cola3.esta_vacia()}")
cola3.encolar(1)
print(f"La cola encolada: {cola3}")
print(f"El elemento que se ha descolado: {cola3.desencolar()}.  ")
