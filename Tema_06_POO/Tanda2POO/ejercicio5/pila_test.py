...
print(f"La longitud de la pila es: {pila1.longitud}")
print(f"{pila1.esta_vacia()}")
pila1.apilar(1)
print(f"La pila, apilada: {pila1}")
print(f"El elemento que se ha desapilado: {pila1.desapilar()}.  ")
...
print(f"La longitud de la pila es: {pila2.longitud}")
pila2.apilar(1)
pila2.apilar(2)
pila2.apilar(3)
pila2.apilar(4)
print(f"La pila, apilada: {pila2}")
print(f"El elemento que se ha desapilado: {pila2.desapilar()}.  ")
...
print(f"La longitud de la pila es: {pila3.longitud}")
pila3.apilar(1)
pila3.apilar(2)
pila3.apilar(3)
pila3.apilar(4)
print(f"La pila, apilada: {pila3}")
print(f"El elemento que se ha desapilado: {pila3.desapilar()}.  ")
